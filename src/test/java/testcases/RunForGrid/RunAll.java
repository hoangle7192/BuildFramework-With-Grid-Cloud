...
public class RunAll extends BaseTest {
    ...
    @Parameters({"envName", "roleName", "browserName", "ipAddress", "portName", "osName", "osVersion", "browserVersion"})
    @BeforeClass
    public void beforeClass(String envName, String roleName, String browserName, String ipAddress, String portName, String osName,
                            String osVersion, String browserVersion) {
        driver = getBrowserDriver(envName, roleName, browserName, ipAddress, portName, osName, osVersion, browserVersion);
    ...
    @Test
    public void TC_03_Edit(Method method) {
        ExtentTestManager.startTest(method.getName(), "TC_03");
    }

    @Test
    public void TC_04_Delete(Method method) {
        ExtentTestManager.startTest(method.getName(), "TC_04");
    }
