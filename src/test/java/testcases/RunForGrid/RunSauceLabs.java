...
public class RunSauceLabs extends BaseTest {
    WebDriver driver;
    Select select;
    String firstName, lastName, email, companyName, password;

    @Parameters({"browserName", "url", "platform", "version"})
    @BeforeClass
    public void beforeClass(String browserName, String url, String platform, String version) {
        driver = getBrowserDriverSauceLabs(browserName, url, platform, version);
